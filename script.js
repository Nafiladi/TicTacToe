const characters = {
    NHLin: { health: 70, energy: 80, description: "Weak, Fast... Like a chicken in Ohio!" },
    BSK: { health: 90, energy: 80, description: "Strong, Quick... Like a squirrel in Ohio!" },
    Darren: { health: 70, energy: 90, description: "Quick, Strong... Probably invented sliced bread!" },
    Hao: { health: 80, energy: 80, description: "Strong, Black... He once won a staring contest with a mirror!" },
    Steve: { health: 90, energy: 85, description: "Calm, Analytical... Can even calm a raging coffee machine!" },
    Jaden: { health: 80, energy: 120, description: "Fast, Engaging... Always has a swim at the ready!" },
    Albert: { health: 165, energy: 55, description: "slow, Focused... He's chasing his dreams, one NHLin at a time!" },
    Noah: { health: 80, energy: 85, description: "Smart, Slow... Could outsmart a fridge in a power cut!" },
    Galvin: { health: 85, energy: 80, description: "Fearless, Brave... Once tried to pet a e-gi**!" },
    Nevin: { health: 70, energy: 70, description: "Slow, Calm... Knows the best Skibidi Watcher!" },
    Jorgina: { health: 85, energy: 65, description: "Surprising, Quick... She once jump-started a car with two spoons!" },
    Vivien: { health: 90, energy: 80, description: "Charming, Witty... Could charm the socks off a statue!" },
    Yanxi: { health: 75, energy: 75, description: "Resourceful, Clever... Uses moan to fix everything!" },
    Junteng: { health: 85, energy: 70, description: "Strong, Brave... Wrestled a bear... and lost with a hug!" },
    Jeff: { health: 145, energy: 60, description: "Smart, Analytical, Calm, Fearless, Brave, Fat... Calculates the best NHLin Gyat!" },
    JeffLai: { health: 80, energy: 65, description: "Slow , Ambitious... Can order pizza in zero languages!" },
    Ethan: { health: 70, energy: 75, description: "Quick... Runs like a cheetah... after kfcs!" },
    Aeryn: { health: 80, energy: 70, description: "Ambitious, Driven... Wants to become a professional ice cream taster!" },
    Javier: { health: 90, energy: 80, description: "Bold, Adventurous... Took his goldfish to the beach!" },
    Iris: { health: 80, energy: 70, description: "Wise, Calm... Should probably run a meditation retreat!" },
    Fredrick: { health: 70, energy: 95, description: "Unique, Energyful... Could sell sand in a desert!" },
    Eddy: { health: 85, energy: 120, description: "Fun, Innovative... Can turn any event into a surprise dance party!" },
    CHZ: { health: 80, energy: 40, description: "Mysterious, Intriguing... Might be a part-time superhero!" },
};
...
function calculateNewStatus(character, diceRoll) {
    // Calculate new energy and add to oxygen
...
// Button Click Event for Fortune Action
